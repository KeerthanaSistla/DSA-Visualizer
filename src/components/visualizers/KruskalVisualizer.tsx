...
import { runKruskal, WeightedGraphNode, WeightedGraphEdge, KruskalStep } from "@/utils/algorithms/kruskal";
...
export const KruskalVisualizer = () => {
  ...
  const resetVisualization = () => {
    const kruskalSteps = runKruskal(nodes, edges);
  ...
  const currentState = steps[currentStep] || { currentEdge: null, mstEdges: [], totalWeight: 0, description: "" };
